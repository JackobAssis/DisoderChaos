...
# Mount system events
signal mount_summoned(entity, mount)
signal mount_dismissed(entity, mount)
signal mount_stamina_changed(entity, current: float, maximum: float)
signal mount_skill_used(entity, skill_id: String)
signal mount_unlocked(entity, mount)
signal mount_dash_performed(entity, mount)
signal mount_speed_changed(entity, old_speed: float, new_speed: float)

# Pet system events
signal pet_summoned(entity, pet)
signal pet_dismissed(entity, pet)
signal pet_level_up(entity, pet, new_level: int)
signal pet_xp_gained(entity, pet, xp_amount: int)
signal pet_unlocked(entity, pet)
signal pet_ability_used(entity, pet, ability_id: String)
signal pet_died(entity, pet)
